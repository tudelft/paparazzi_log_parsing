function plot_rotwing_flight_envelope(params, plot_title)
...
constants = [params.FW_MIN_AIRSPEED, params.FW_QUAD_MIN_AIRSPEED, params.FW_CRUISE_AIRSPEED, ...
    ...
    params.SKEW_UP_AIRSPEED, params.SKEW_DOWN_AIRSPEED];

labels = {"FW\_MIN\_AIRSPEED", "FW\_QUAD\_MIN\_AIRSPEED", "FW\_CRUISE\_AIRSPEED", "FW\_MAX\_AIRSPEED", ...
    "QUAD\_NOPUSH\_AIRSPEED", "QUAD\_MAX\_AIRSPEED", "SKEW\_UP\_AIRSPEED", "SKEW\_DOWN\_AIRSPEED"};

skewing_x_vals = [0, 0, params.SKEW_ANGLE_STEP, params.SKEW_ANGLE_STEP, 90, 90];
skewing_y_vals = [0, params.SKEW_UP_AIRSPEED, params.SKEW_UP_AIRSPEED, params.QUAD_MAX_AIRSPEED, params.FW_MIN_AIRSPEED, params.FW_MAX_AIRSPEED];

hysteresis_x_vals = [params.SKEW_ANGLE_STEP, params.SKEW_ANGLE_STEP, 0, 0];
hysteresis_y_vals = [params.SKEW_UP_AIRSPEED, params.SKEW_DOWN_AIRSPEED, params.SKEW_DOWN_AIRSPEED, 0];
