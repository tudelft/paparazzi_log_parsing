...
% Plot airframe
AV_hg = hgtransform;
set(AV_hg, 'Matrix', quat2tform(Model3D.AircraftRot))
...
for i=1:length(Model3D.Control)
    ...
    plot3(p(1)+[0, AC_DIMENSION*vect(1)/2], p(2)+[0, AC_DIMENSION*vect(2)/2], p(3)+[0, AC_DIMENSION*vect(3)/2], 'b-o', 'MarkerSize', 10, 'LineWidth', 2, 'Parent', AV_hg);
end
